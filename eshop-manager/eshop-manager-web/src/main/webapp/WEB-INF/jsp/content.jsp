        ...
        <div data-options="region:'center'" style="padding:5px">
		    ...
		    <thead>
		        <tr>
		            ...
		            <th data-options="field:'url',width:60,align:'center'">内容连接</th>
		            <th data-options="field:'pic',width:50,align:'center',formatter:ESHOP.formatUrl">图片</th>
		            <th data-options="field:'content',width:50">內容</th>
